...
import { Clock, MapPin, DollarSign, Info, Navigation, Calendar } from 'lucide-react';
  ...
  return (
    <div className="py-4 space-y-8">
      <div className="text-center space-y-2">
        ...
        <p className="text-gray-600">{itineraryList.length} Days of Experiences</p>
      </div>
      <Tabs defaultValue={itineraryList[0]?.Day?.toLowerCase() || "day-1"} className="w-full">
        ...
        {placesWithImages.map((day, dayIndex) => (
          <TabsContent key={dayIndex} value={day.Day.toLowerCase()} className="space-y-6">
                    ...
                    <div className="flex-1">
                      <CardHeader className="bg-gray-50">
                        <div className="flex items-start justify-between">
                          <div>
                            <CardTitle className="text-xl mb-2">{activity.Activity}</CardTitle>
                            ...
                            <div className="flex items-center gap-2 mt-2 text-gray-600">
                              <MapPin size={16} />
                              <span className="text-sm">{activity.ActivityLocation}</span>
                            </div>
                          </div>
                      ...
                      <CardContent className="pt-4">
                        <div className="space-y-4">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            {activity.ModeOfTravel && activity.TravelTime !== 'N/A' && (
                              <div className="flex items-center gap-2">
                                <Navigation size={16} className="text-gray-500" />
                                <span className="text-sm">
                                  {activity.ModeOfTravel} • {activity.TravelTime}
                                </span>
                              </div>
                            )}
                          </div>
                          ...
                          {activity.NearbyAttractions?.length > 0 && (
                            <div className="border-t pt-4">
                              ...
                              <div className="flex flex-wrap gap-2">
                                {activity.NearbyAttractions.map((attraction, i) => (
                          ...
                          {activity.BookingLink && activity.BookingLink !== 'N/A' && (
                            <a
